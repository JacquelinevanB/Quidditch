...
public class Team {
    ...
    public Team(String house, String keeper, String seeker, String[] chasers) {
        if (house == null || keeper == null || seeker == null) throw new IllegalArgumentException("Field values cannot be null.");
        if (house.isBlank() || keeper.isBlank() || seeker.isBlank()) throw new IllegalArgumentException("Field values cannot be blank.");
        if (chasers.length != 3) throw new IllegalArgumentException("Must have 3 chasers.");
        if (hasNull(chasers) || hasBlank(chasers)) throw new IllegalArgumentException("Illegal elements");
    ...
    public void setChasers(String[] chasers) {
        if (chasers.length != 3 || hasNull(chasers) || hasBlank(chasers)) throw new IllegalArgumentException("Illegal chaser arguments");
        this.chasers = Arrays.copyOf(chasers, chasers.length);
    }

    public void checkParam(String param) {
        if (param == null || param.isBlank()) throw new IllegalArgumentException("field cannot be null or blank");
    }
